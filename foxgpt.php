...
FoxGPTは、Athenaiが100万件以上の文対データから、オープンソースであるOpenNMTを用いて独自に作成した<br>
...
本コードにより対話を行う場合、バックグラウンドで通信先のPythonプログラムを動作せる必要があります。<br>
また、名前付きpipeを2つ作成しておいてください。詳細はReadMeをご覧ください。<br>
...
<?php
      if ($_SERVER['REQUEST_METHOD'] === 'POST') {
         ...
         <dt>FoxGPTよりお返事</dt>
         <dd>
         <div class="message">こんにちは、わたしはFoxGPTです。<br>たくさんおはなししてください。</div>
         </dd>
         </dl>';
      }
